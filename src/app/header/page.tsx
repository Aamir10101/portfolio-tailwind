...
export default function Header(){
    return(
        <div className="min-h-screen flex flex-col items-center bg-gray-200">
            ...
            {/* navbar */}
            <header className="w-full text-white p-4 bg bg-gray-800 flex justify-between">
                <div className="flex items-center">
                <Image src="/new-image.jpg"alt="myimage" width={50} height={50} className="rounded-full"/>
                <h1 className="font-bold text-4xl pl-4">Amir Ansari</h1>
                </div>
      ...
      <div className="relative h-screen w-full overflow-hidden">
        ...
        <Image src="/new-image.jpg" alt="myImage" width={500} height={200} className="rounded-full border-4 border-gray-600 shadow-lg  hover:scale-110 ease-in-out transition duration-500"/>
        <h1 className=" text-4xl font-bold transition duration-500 ease-in-out transform hover:scale-110 items-center mt-10 ">Amir Ansari</h1>
        </div>
